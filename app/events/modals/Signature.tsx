...
export default function Signature({ open, onClose }: SignatureProps) {
  if (!open) return null;
  ...
  const menuSections = [
    {
      category: "SOUP",
      icon: <Soup size={18} />,
      items: ["Roasted Butternut Squash Soup with freshly baked artisan breads"]
    },
    {
      category: "SALAD",
      icon: <Salad size={18} />,
      items: [
        "Salad Bar - Organic mixed greens, tomatoes, cucumber, carrots, jicama with Balsamic Vinaigrette, Ranch",
        "Austrian Potato Salad, Coleslaw"
      ]
    },
    {
      ...
      icon: <Flame size={18} />,
      items: [
        "Beef and Ox Tongue Pastel",
        "Pollo Iberico",
        "Pasta Paella",
        "Salt Baked Salmon with Lemon Butter Caper Sauce",
    ...
    },
    {
      ...
      items: [
        ...
        "Pecan Bread Pudding with Chocolate Sauce",
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-3 font-jost backdrop-blur-sm">
      ...
      <div className="relative w-full max-w-[900px] bg-white shadow-2xl overflow-hidden rounded-xl md:rounded-lg max-h-[90vh] flex flex-col">
        ...
        <div className="relative w-full h-[200px] md:h-[280px] flex-shrink-0">
          <Image
            src="/events/signature/signature1x1.png"
          ...
          <div className="absolute bottom-0 w-full flex justify-center">
            <div className="bg-white text-[#F26522] text-sm md:text-xl tracking-wide px-4 md:px-8 py-2 md:py-3 mb-3 md:mb-4 font-semibold rounded-full md:rounded-none shadow-lg md:shadow-none">
              1,800 + 5% SERVICE CHARGE • MINIMUM OF 50 PAX
            </div>
          </div>
