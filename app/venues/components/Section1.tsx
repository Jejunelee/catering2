...
export default function Section1() {
  ...
  const venueImages = [
    [
      "/venues/locations/maginhawa/1.webp",
      "/venues/locations/maginhawa/2.webp",
      "/venues/locations/maginhawa/3.webp",
      "/venues/locations/maginhawa/4.webp",
      "/venues/locations/maginhawa/5.webp", 
      "/venues/locations/maginhawa/6.webp",
      "/venues/locations/maginhawa/7.webp", 
    ...
    [
      "/venues/locations/katipunan/1.webp",
      "/venues/locations/katipunan/2.webp",
      "/venues/locations/katipunan/3.webp",
    ],
    [
